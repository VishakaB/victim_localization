...
def theta_limits(theta_truth, max_error_angle):
    ...
    amin=theta_truth-(max_error_angle)/2#theta error opening 
    amax=theta_truth+(max_error_angle)/2
...
def error_range(range,outdoor_los,outdoor_nlos,indoor_nlos):
    if (outdoor_los==True):
        e_y = range*Interval(random.randint(-10000,-1000),random.randint(1000,10000))
    elif (outdoor_nlos==True):
        e_y = range*Interval(random.randint(-10000,-1000),random.randint(1000,10000))
    elif (indoor_nlos==True):
        e_y = range*Interval(random.randint(-10000,-1000),random.randint(1000,10000))
...
def error_gps(gpsestimate,outdoor_los,outdoor_nlos,indoor_nlos):
    if (outdoor_los==True):
        e_g = gpsestimate*Interval(random.randint(-10000,-1000),random.randint(1000,10000))
    elif (outdoor_nlos==True):
        e_g = gpsestimate*Interval(random.randint(-10000,-1000),random.randint(1000,10000))
    elif (indoor_nlos==True):
        e_g = gpsestimate*Interval(random.randint(-10000,-1000),random.randint(1000,10000))
            ...
            if (v_obs[0].is_empty()):
                ...
                for i in range (0,len(v_obs)): # for each range and bearing measurement
                      ...
                      if (node_incoverage.get(iter)!=None):
                          a = theta_limits(v_obs[i][1].mid(),math.pi/3)
                ...
                contraction_dt = cn.contract_during(2)#csp solving time set to 2 sec
