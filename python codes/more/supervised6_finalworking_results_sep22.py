...
for i in range(1,rows):
    ...
    if (outdoor_los==True):
        ...
        e_g = Interval(random.randint(-3000,0),random.randint(0,5000))
...
def error_range_toa(range,outdoor_los,outdoor_nlos,indoor_nlos):
    if (outdoor_los==True):
        ...
        e_y = range*Interval(random.randint(-3,-1),random.randint(1,3))
    return e_y
...
def collect_data(j,emergarr,all_x_gps):
    ...
    e_aoa = Interval(random.randint(-1000000,-0),random.randint(0,1000000))
                ...
                for i in range (0,len(b)): # for each range and bearing measurement
                      ...
                      if (node_incoverage.get(iter)==None):#out of coverage                         
                          ...
                          for hh in v_obs: # for each observation:
                            e_y = 0.01*hh[0]*Interval(random.randint(-3000,-1000),random.randint(1000,3000))
                            hh[0]= hh[0]+e_y#range
